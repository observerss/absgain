...
def best(k=10, use_selected=False, remove_recent_year=False):
    ...
    while True:
        ...
        if best_score == 0 or best_score < score:
            ...
            with open(f'mix_k{k}_{"selected" if use_selected else "all"}.txt', 'a') as f:
...
if __name__ == '__main__':
    ...
    best(k=20, use_selected=True)
    # best(k=20, use_selected=False)