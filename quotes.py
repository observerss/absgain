...
def select_symbols():
    ...
    columns = [
        'symbol', 'name', 'brief', 'last_traded_at', 'net_value', 'all_time_net_value', 
        '1day_return', '7day_return', '30d_return', '90d_return', '180d_return',
        '1y_return', '2y_return', '3y_return', 'this_year_return', 'all_time_return',
        'issued_at', 'min_subscription', 'custom', 'subscription_fee', 'subscription_fee_discounted', 'min_kept_subscription', 'x1', 'x2', 'amount']
